    ...
    <div className="min-h-screen bg-background text-foreground background-gradient-blobs">
      ...
      <section className="relative h-screen overflow-hidden flex items-center justify-center">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Link href={productsConfig.hero.ctaLink || '/contact'}>
            <Button className="btn-primary px-8 py-3 text-lg">
              {productsConfig.hero.ctaText}
            </Button>
          </Link>
        </div>
      </section>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl lg:text-5xl mb-6">
              {productsConfig.packages.title}
            </h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              {productsConfig.packages.description}
            </p>
          </div>

          <div className="grid md:grid-cols-3 gap-8">
            {productsConfig.packages.tiers.map((tier, index) => (
              <div
                key={tier.id}
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {productsConfig.recentWork.images.length > 0 ? (
            <div className="grid md:grid-cols-3 gap-6">
              {productsConfig.recentWork.images.map((image, index) => (
