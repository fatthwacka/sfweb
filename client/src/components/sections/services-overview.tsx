      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            From intimate portraits to grand celebrations, from Ai automations and websites to mobile apps, we execute every project with artistic vision and technical excellence.
          </p>
        </div>
