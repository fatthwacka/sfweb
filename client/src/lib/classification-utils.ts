...
export const CLASSIFICATION_CLUMPING = {
  ...
  events: ['event', 'lifestyle', 'party', 'celebration', 'birthday'],
...
// Returns shuffled results for diverse display across albums
export const getImagesByCategory = (categoryKey: CategoryKey, images: Image[]): Image[] => {
  ...
  // Shuffle the results so images from different albums are interleaved
  // This prevents repetitive-looking grids when images are sorted by album
