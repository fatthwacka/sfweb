...
**⚠️ NOTE: This document contains historical architecture information extracted from CLAUDE.md. Much of this content may be outdated and will need verification and updates based on recent changes.**
...
- `VITE_SUPABASE_PUBLISHABLE_KEY` - Supabase publishable key for client-side operations
